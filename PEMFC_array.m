...
%%%%%%%%%%%%%%%%for Ohmc & Cathodic Overpotential%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

V = sym([]);
j_plot = [];
j = 0;
%this is current in A/cm^2
...
E_o = j*fInt;
%this would be ohmic overpotential [Volts]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%to find E_c or the Cathode overpotential%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
E_c = (((R*T)/(4*0.5*F))*log(j/(j_0*p_c*101300)*1/(x_o-t_C*0.000001*(j*10000*R*T)/(4*F*p_c*101325*D_effc*0.0001))));
